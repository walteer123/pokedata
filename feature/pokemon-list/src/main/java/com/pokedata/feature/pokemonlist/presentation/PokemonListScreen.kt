            ...
            LazyColumn(
                ...
                items(
                    ...
                    Row(
                        ...
                        if (leftIndex < pokemon.itemCount) {
                            val pokemonItem = pokemon[leftIndex]
                            if (pokemonItem != null) {
                                with(sharedTransitionScope) {
                                    PokemonCard(
                                        id = pokemonItem.id,
                        ...
                        if (rightIndex < pokemon.itemCount) {
                            val pokemonItem = pokemon[rightIndex]
                            if (pokemonItem != null) {
                                with(sharedTransitionScope) {
                                    PokemonCard(
                                        id = pokemonItem.id,
